...
class AdminaddItem extends StatefulWidget {
  AdminaddItem({Key? key}) : super(key: key);

  @override
  State<AdminaddItem> createState() => _HomeState();
}

class _HomeState extends State<AdminaddItem> with Crud {
  ...
  addCtegories() async {
    ...
    var response9 = await postRequestWithFile(linkAdminAddItem, {
      "name": name.text!,
      "description" : description.text!,
      "price" : price.text!,
      "id_category":sharedPref.getString("id_category").toString(),
