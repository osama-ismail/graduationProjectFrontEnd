...
class AdminaddDoctor extends StatefulWidget {
  AdminaddDoctor({Key? key}) : super(key: key);

  @override
  State<AdminaddDoctor> createState() => _SignupState();
}

class _SignupState extends State<AdminaddDoctor> {
  ...
  void initState() {
    ...
    if(sharedPref.getString("editDoctor").toString()!="") {
    String jsonString = sharedPref.getString("editDoctor").toString();
    ...
    if(yourObject!=""){
      ...
      password = TextEditingController(text: yourObject?["salary"]);
