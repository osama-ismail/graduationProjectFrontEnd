...
class MLCalenderComponent5 extends StatefulWidget {
...
class MLCalenderComponentState extends State<MLCalenderComponent5> {
        ...
        itemBuilder: (BuildContext context, int index) {
          return Container(
            ...
            decoration: boxDecorationWithRoundedCorners(
              backgroundColor: currentDateSelectedIndex == index+7
                  ? mlColorBlue
            ...
            child: Column(
              ...
              children: [
                ...
                sharedPref.getString("day")== DateTime.now().add(Duration(days: index)).day.toString()? Text(
                  ...
                  style: secondaryTextStyle(size: 16, color: currentDateSelectedIndex == index+7 ? Colors.red : mlColorBlue),
                ):Text(
                  listOfDays[DateTime.now().add(Duration(days: index)).weekday - 1].toString(),
                  style: secondaryTextStyle(size: 16, color: currentDateSelectedIndex == index+7? Colors.red : mlColorBlue),
                ),
                ...
                Text(
                  ...
                  style: boldTextStyle(
                      size: 22,
                      color: currentDateSelectedIndex == index+1
                          ? white
                          : appStore.isDarkModeOn
                              ? white
                              : black),
            ...
            () {
              setState(
                () {
                  currentDateSelectedIndex = index+1;
