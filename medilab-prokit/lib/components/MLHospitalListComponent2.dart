...
class MLHospitalListComponent2 extends StatefulWidget {
...
class MLHospitalListComponentState extends State<MLHospitalListComponent2> {
      ...
      if (decodedData is List) {
        setState(() {
          oo = List<Map<String, dynamic>>.from(decodedData.map((item) => item as Map<String, dynamic>))
              .where((item) => item['name'] == "Elderly care")
              .toList();
          isLoading = false;
        });
      }
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Home Visit', style: boldTextStyle(size: 24)),
                  8.height,
                ],
              ).expand(),
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    16.height,
                    Text((oo[0]["name"]), style: boldTextStyle()),
                    8.height,
