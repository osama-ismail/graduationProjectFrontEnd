...
import 'MLCalenderComponent5.dart';

class MLScheduleApoointmentSheetPatient extends StatefulWidget {
...
class MLScheduleApoointmentSheetState extends State<MLScheduleApoointmentSheetPatient> {
  ...
  onDelete(String time) async {
    var response = await http.get(Uri.parse(linkIp + "/patient/deletePatientAppointmentsPateint?time="+time+"&date="+sharedPref.getString("day")!+"&service_patient="+sharedPref.getString("id")!));
    finish(context);
    showModalBottomSheet(
      isScrollControlled: true,
      context: context,
      builder: (builder) {
        return MLScheduleApoointmentSheetPatient();
      },
    );
